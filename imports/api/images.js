...
const s3Conf= {
    key: "spjJN1Mbl5Fh5GFisUguP3/04BIuwqLCywTFlXzm",
    secret: "AKIAJJKU2FNCCJPBGYMA",
    bucket: "ebazaaronline"
  };
            ...
            if (error) {
              ...
              this.collection.update({
                ...
                if (updError) {
                  ...
                  //we should enable line below for production
...
Images.allow({
    ...
    Meteor.publish('image', function imagesPub(imageId) {
        ...
        return Images.find({_id: imageId}).cursor;
    });
