Feature: Managing purchases
	...
	Scenario: User knowing about his unprocessed purchases
		Given I have "1" pending purchases	
		Then I should not see an unread mark on app menu 
		Then I click app menu button	
		Then I should see "1" in the counter next to "my-purchases" in the app menu		

	Scenario: User with no purchase items yet
		Given I have "0" new processed purchases
		Then I should not see an unread mark on app menu 
		Then I click app menu button				
		Then I should see "0" in the counter next to "my-purchases" in the app menu
	...
	Scenario: User viewing a newly processed purchase
		...
		And I should see "0" in the counter next to "my-purchases" in the app menu